...
export class userMigration1778505600000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "main"."user_role_enum" AS ENUM('user', 'creator')`);
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: "role", type: '"main"."user_role_enum"', default: `'user'`, isNullable: false, },
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE IF EXISTS "main"."user_role_enum"`);
    }
}